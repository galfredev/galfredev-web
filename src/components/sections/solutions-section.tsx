            ...
            <Reveal key={solution.title} delay={index * 0.04}>
              <BorderGlowCard className="p-6">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="rounded-full border border-white/10 bg-black/20 px-3 py-1 text-[11px] uppercase tracking-[0.22em] text-white/42">
                    {solution.audience}
                  </span>
                </div>

                <h3 className="mt-5 max-w-md text-2xl font-medium tracking-[-0.05em] text-white">
                  {solution.title}
                </h3>

                <div className="mt-5 grid gap-4 text-sm leading-7 text-white/64">
                  <p>{solution.pain}</p>
                  <p className="rounded-2xl border border-white/8 bg-black/16 px-4 py-3 text-white/78">
                    {solution.outcome}
                  </p>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-7 inline-flex items-center gap-2 rounded-full border border-[var(--color-accent)]/26 bg-[var(--color-accent)]/10 px-5 py-3 text-sm text-white transition hover:border-[var(--color-accent)]/48 hover:bg-[var(--color-accent)]/16"
                >
                  {solution.ctaLabel}
                  <ArrowRight size={16} />
                </a>

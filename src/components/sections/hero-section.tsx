        ...
        <div className="space-y-9">
          ...
          <div className="space-y-7">
            <motion.h1
              ...
              className="max-w-[11.6ch] text-balance text-[3.35rem] font-semibold leading-[0.92] tracking-[-0.085em] text-white sm:max-w-[10.8ch] sm:text-[4.4rem] lg:max-w-[10.1ch] lg:text-[5.55rem]"
            >
          ...
          >
            ...
            <a
              href="#roi"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/12 bg-white/[0.035] px-6 py-3.5 text-sm text-white/84 transition duration-300 hover:border-white/20 hover:bg-white/[0.055] hover:text-white active:scale-[0.985]"
            >
            ...
            {heroMetrics.map((metric, index) => (
              ...
              >
                ...
                >
                  ...
                  <p className={index === 0 ? 'text-sm leading-6 text-white/66' : 'text-sm leading-6 text-white/56'}>
                    {metric.detail}
                  </p>
                </motion.div>
              </BorderGlowCard>
